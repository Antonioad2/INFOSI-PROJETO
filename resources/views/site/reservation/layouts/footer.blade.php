<!-- Footer -->
<footer class="footer"
    style="display:block!important;opacity:1!important;position:relative!important;z-index:9999;background:#222;color:#fff;">
    <!-- Footer Top -->
                    ...
                    <div class="footer-contact footer-widget">
                        ...
                        <div class="footer-contact-info">
                            ...
                            <div class="footer-address">
                                ...
                                <div class="addr-info">
                                    <a href="mailto:info@dreamsrent.com">info@dreamsrent.com</a>
                                </div>
                            ...
                            <div class="vistors-details">
                                <ul class="d-flex">
                                    <li><a href="javascript:void(0)"><img class="img-fluid"
                                                src="{{ url('assets/user/img/icons/paypal.svg') }}" alt="Paypal"></a>
                                    </li>
                                    <li><a href="javascript:void(0)"><img class="img-fluid"
                                                src="{{ url('assets/user/img/icons/visa.svg') }}" alt="Visa"></a>
                                    </li>
                                    <li><a href="javascript:void(0)"><img class="img-fluid"
                                                src="{{ url('assets/user/img/icons/master.svg') }}" alt="Master"></a>
                                    </li>
                                    <li><a href="javascript:void(0)"><img class="img-fluid"
                                                src="{{ url('assets/user/img/icons/applegpay.svg') }}"
                                                alt="applegpay"></a></li>
                                </ul>
                            </div>
                        </div>
