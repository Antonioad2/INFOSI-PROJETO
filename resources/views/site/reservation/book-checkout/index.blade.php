...
@section('title', 'AngoCars Detalhe de Checkout')
@section('content')
							...
							<div class="booking-wizard-lists">
								<ul>
									<li class="active activated">
										<span><img src="{{ url('assets/user/img/icons/booking-head-icon-01.svg')}}" alt="Booking Icon"></span>
										<h6>Location & Time</h6>
									</li>
									<li class="active">
										<span><img src="{{ url('assets/user/img/icons/booking-head-icon-02.svg')}}" alt="Booking Icon"></span>
										<h6>Extra Services</h6>
									</li>
									<li>
										<span><img src="{{ url('assets/user/img/icons/booking-head-icon-03.svg')}}" alt="Booking Icon"></span>
										<h6>Detail</h6>
									</li>
									<li>
										<span><img src="{{ url('assets/user/img/icons/booking-head-icon-04.svg')}}" alt="Booking Icon"></span>
										<h6>Checkout</h6>
									</li>
									<li>
										<span><img src="{{ url('assets/user/img/icons/booking-head-icon-05.svg')}}" alt="Booking Icon"></span>
							...
							<div class="booking-information-main">
								<form action="https://dreamsrent.dreamstechnologies.com/html/template/booking-detail.html">
												...
												<ul class="acting-driver-list">
													<li>
														<div class="driver-profile-info">
															<span class="driver-profile"><img src="{{ url('assets/user/img/drivers/driver-02.jpg')}}" alt="Img"></span>
									...
									<div class="booking-info-btns d-flex justify-content-end">
										<a href="booking-checkout.html" class="btn btn-secondary">Voltar para Localização e Tempo</a>
										...
										<div id="accordion_collapse_one" class="accordion-collapse collapse">
											<div class="booking-sidebar-body">
												<div class="booking-car-detail">
													<span class="car-img">
														<img src="{{ url('assets/user/img/car-list-4.jpg')}}" class="img-fluid" alt="Car">
													</span>
								...
								<div class="booking-sidebar-card">
									<div class="accordion-item border-0 mb-4">
										<div class="accordion-header p-3 d-flex align-center justify-content-between">
											...
											<a href="booking-checkout.html" class="d-flex align-items-center sidebar-edit"><i class="bx bx-edit-alt me-2"></i>Edit</a>
										</div>
