                                            ...
                                            <ul>
                                                    ...
                                                    <label class="payment_custom_check">
                                                        ...
                                                        <span class="payment_checkmark">
                                                            <span class="checked-title"><img
                                                                    src="assets/user/img/icons/payment-1.svg"
                                                                    alt="Imagem"></span>
                                                        </span>
                                                    </label>
                                                </li>
                                                <li>
                                                    <label class="payment_custom_check">
                                                        ...
                                                        <span class="payment_checkmark">
                                                            <span class="checked-title"><img
                                                                    src="assets/user/img/icons/payment-2.svg"
                                                                    alt="Imagem"></span>
                                                        </span>
                                                    </label>
                                                </li>
                                                <li>
                                                    <label class="payment_custom_check">
                                                        ...
                                                        <span class="payment_checkmark">
                                                            <span class="checked-title"><img
                                                                    src="assets/user/img/icons/payment-3.svg"
                                                                    alt="Imagem"></span>
                                                        </span>
                                                    </label>
                                                </li>
                                                <li>
                                                    <label class="payment_custom_check">
                                                        ...
                                                        <span class="payment_checkmark">
                                                            <span class="checked-title"><img
                                                                    src="assets/user/img/icons/payment-4.svg"
                                                                    alt="Imagem"></span>
                                                        </span>
                                                    </label>
                                                </li>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <label class="payment_custom_check">
                                                                ...
                                                                <span class="payment_checkmark">
                                                                    <span class="checked-title"><img
                                                                            src="assets/user/img/dicovery.svg"
                                                                            alt="Imagem"></span>
                                                                    <small>
                                                                        <font dir="auto"
                                                                            style="vertical-align: inherit;">
