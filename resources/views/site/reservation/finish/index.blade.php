        ...
        <div class="booking-new-module">
			<div class="container">
						...
						<div class="col-lg-12">
							<div class="book-card mb-0">
								...
								<div class="book-body">
									<ul class="location-lists">
										<li>
											<p>As empresas de aluguel geralmente exigem que os clientes devolvam o veículo com o tanque cheio. Se o veículo for devolvido com menos de um tanque cheio, os clientes podem ser cobrados pelo reabastecimento do veículo a uma tarifa premium, geralmente mais alta que os preços locais de combustível.</p>
										</li>
									</ul>
								</div>
							</div>
				...
				<div class="print-btn text-center">
					<a href="javascript:void(0);" class="btn btn-secondary">Imprimir Pedido</a>
				</div>
			</div>
		</div>
		<!-- /Sucesso na Reserva -->
