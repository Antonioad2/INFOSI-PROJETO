                    ...
                    <div class="row g-5">
                        <div class="col-lg-8">
                            ...
                            <div class="car-details-items">
                                <div class="car-image">
                                    <img src="{{ url('assets/user/img/car/car-details.jpg') }}" alt="img">
                                </div>
                                <div class="car-content">
                                    ...
                                    <div class="car-video">
                                        <img src="{{ url('assets/user/img/car/car-details-2.jpg') }}" alt="img">
                                        <div class="video-box">
                            ...
                            {{-- <div class="comment-reviews">
                                ...
                                <div class="car-single-comment d-flex gap-4 pb-5">
                                    <div class="image">
                                        <img src="{{ url('assets/user/img/car/comment01.png')}}" alt="image">
                                    </div>
                                    <div class="content">
                                ...
                                <div class="car-single-comment d-flex gap-4 pt-5 border-none">
                                    <div class="image">
                                        <img src="{{ url('assets/user/img/car/comment02.png')}}" alt="image">
                                    </div>
                                    <div class="content">
                                        <div class="head d-flex flex-wrap gap-3 align-items-center justify-content-between">
                                            <div class="con">
