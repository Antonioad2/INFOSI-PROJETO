...
<head>
        ...
        <!--<< DatePicker.css >>-->
        <link rel="stylesheet" href="assets/user/css/datepickerboot.css">
        <!--<< Swiper Bundle.css >>-->
