...
<!-- Mirrored from dreamsrent.dreamstechnologies.com/html/template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Sep 2025 11:21:41 GMT -->
<head>
	<meta charset="utf-8">
...
<body>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <div class="single-demo active">
                                                        <div class="demo-img">
                                                            <a href="index.html">
																<img src="{{ url('assets/user/img/menu/home-01.svg')}}" class="img-fluid " alt="img">
															</a>
                                                        </div>
                                                        <div class="demo-info">
												...
												<div class="col-lg-3">
                                                    <div class="single-demo">
                                                        <div class="demo-img">
                                                            <a href="index-2.html">
																<img src="{{ url('assets/user/img/menu/home-02.svg')}}" class="img-fluid " alt="img">
															</a>
                                                        </div>
                                                        <div class="demo-info">
												...
												<div class="col-lg-3">
                                                    <div class="single-demo">
                                                        <div class="demo-img">
                                                            <a href="index-3.html">
																<img src="{{ url('assets/user/img/menu/home-03.svg')}}" class="img-fluid " alt="img">
															</a>
                                                        </div>
                                                        <div class="demo-info">
												...
												<div class="col-lg-3">
                                                    <div class="single-demo">
                                                        <div class="demo-img">
                                                            <a href="index-4.html">
																<img src="{{ url('assets/user/img/menu/home-04.svg')}}" class="img-fluid " alt="img">
															</a>
                                                        </div>
                                                        <div class="demo-info">
							...
							<div class="banner-content">
								...
								<div class="customer-list">
									<div class="users-wrap">
										<ul class="users-list">
											<li>
												<img src="{{ url('assets/user/img/profiles/avatar-11.jpg')}}" class="img-fluid aos" alt="bannerimage">
											</li>
											<li>
												<img src="{{ url('assets/user/img/profiles/avatar-15.jpg')}}" class="img-fluid aos" alt="bannerimage">
											</li>
											<li>
												<img src="{{ url('assets/user/img/profiles/avatar-03.jpg')}}" class="img-fluid aos" alt="bannerimage">
											</li>
										</ul>
						...
						<div class="col-lg-7">							
							<div class="banner-image">
								<div class="banner-img" data-aos="fade-down">
									...
									<img src="{{ url('assets/user/img/banner/banner.png')}}" class="img-fluid" alt="img">
								</div>
							</div>
						</div>
				   	</div>
						...
						<div class="row row-gap-4">
							...
							<div class="col-xl-2 col-md-4 col-sm-6 d-flex">
								<div class="category-item flex-fill">
									...
									<div class="category-img">
										<img src="{{ url('assets/user/img/category/category-01.png')}}" alt="img" class="img-fluid">
									</div>
								</div>
							</div>
							<!-- /Category Item -->
							...
							<div class="col-xl-2 col-md-4 col-sm-6 d-flex">
								<div class="category-item flex-fill">
									...
									<div class="category-img">
										<img src="{{ url('assets/user/img/category/category-02.png')}}" alt="img" class="img-fluid">
									</div>
								</div>
							</div>
							<!-- /Category Item -->
							...
							<div class="col-xl-2 col-md-4 col-sm-6 d-flex">
								<div class="category-item flex-fill">
									...
									<div class="category-img">
										<img src="{{ url('assets/user/img/category/category-03.png')}}" alt="img" class="img-fluid">
									</div>
								</div>
							</div>
							<!-- /Category Item -->
							...
							<div class="col-xl-2 col-md-4 col-sm-6 d-flex">
								<div class="category-item flex-fill">
									...
									<div class="category-img">
										<img src="{{ url('assets/user/img/category/category-04.png')}}" alt="img" class="img-fluid">
									</div>
								</div>
							</div>
							<!-- /Category Item -->
							...
							<div class="col-xl-2 col-md-4 col-sm-6 d-flex">
								<div class="category-item flex-fill">
									...
									<div class="category-img">
										<img src="{{ url('assets/user/img/category/category-05.png')}}" alt="img" class="img-fluid">
									</div>
								</div>
							</div>
							<!-- /Category Item -->
							...
							<div class="col-xl-2 col-md-4 col-sm-6 d-flex">
								<div class="category-item flex-fill">
									...
									<div class="category-img">
										<img src="{{ url('assets/user/img/category/category-06.png')}}" alt="img" class="img-fluid">
									</div>
								</div>
							</div>
							<!-- /Category Item -->
				...
				<div class="row">
						...
						<div class="listing-item listing-item-two">										
								...
								<div class="img-slider owl-carousel">
									<div class="slide-images">
										<a href="listing-details.html">
											<img src="{{ url('assets/user/img/cars/car-11.jpg')}}" class="img-fluid" alt="Toyota">
										</a>
									</div>
									<div class="slide-images">
										<a href="listing-details.html">
											<img src="{{ url('assets/user/img/cars/car-12.jpg')}}" class="img-fluid" alt="Toyota">
										</a>
									</div>
									<div class="slide-images">
										<a href="listing-details.html">
							...
							<div class="listing-content">
								...
								<div class="listing-details-group">
									<ul>
										<li>
											<img src="{{ url('assets/user/img/icons/car-parts-01.svg')}}" alt="Auto">
											<p>Auto</p>
										</li>
										<li>
											<img src="{{ url('assets/user/img/icons/car-parts-02.svg')}}" alt="10 KM">
											<p>10 KM</p>
										</li>
										<li>
											<img src="{{ url('assets/user/img/icons/car-parts-03.svg')}}" alt="Petrol">
											<p>Diesel</p>
										</li>
										<li>
											<img src="{{ url('assets/user/img/icons/car-parts-05.svg')}}" alt="2018">
											<p>2018</p>	
										</li>
									</ul>
								</div>	
					...
					<div class="col-lg-4 col-md-6">
						<div class="listing-item listing-item-two">										
							<div class="listing-img">
								<a href="listing-details.html">
									<img src="{{ url('assets/user/img/cars/car-13.jpg')}}" class="img-fluid" alt="Toyota">
								</a>
								<div class="fav-item">
									<div class="d-flex align-items-center gap-2">
										<span class="featured-text">Toyota</span>
						...
						<div class="listing-item listing-item-two">										
							<div class="listing-img">
								<div class="img-slider owl-carousel">
									<div class="slide-images">
										<a href="listing-details.html">
											<img src="{{ url('assets/user/img/cars/car-14.jpg')}}" class="img-fluid" alt="Toyota">
										</a>
									</div>
									<div class="slide-images">
										<a href="listing-details.html">
									...
									<div class="slide-images">
										<a href="listing-details.html">
											<img src="{{ url('assets/user/img/cars/car-16.jpg')}}" class="img-fluid" alt="Toyota">
										</a>
									</div>
								</div>
								<div class="fav-item">
					...
					<div class="col-lg-4 col-md-6">
						<div class="listing-item listing-item-two">										
							<div class="listing-img">
								<a href="listing-details.html">
									<img src="{{ url('assets/user/img/cars/car-15.jpg')}}" class="img-fluid" alt="Toyota">
								</a>
								<div class="fav-item">
									<div class="d-flex align-items-center gap-2">
										<span class="featured-text">Toyota</span>
				...
				<div class="row align-items-center">
					<div class="col-lg-7">
						<div class="rental-img">
							...
							<div class="grid-img">
								<img src="{{ url('assets/user/img/about/car-grid.png')}}" alt="img" class="img-fluid">
							</div>
						</div>						
					</div>
					<div class="col-lg-5">
				...
				<div class="car-slider owl-carousel">
					...
					<div class="car-item">
						...
						<div class="spec-list">
							...
							<span><img src="{{ url('assets/user/img/icons/spec-05.svg')}}" alt="img">5 Persons</span>
						</div>
					...
					<div class="car-item">
						...
						<div class="spec-list">
							...
							<span><img src="{{ url('assets/user/img/icons/spec-05.svg')}}" alt="img">4 Persons</span>
						</div>
						<a href="listing-details.html" class="btn btn-primary">Rent Now</a>
					</div>
					<!-- /Car Item -->
					...
					<div class="car-item">
						...
						<div class="spec-list">
							...
							<span><img src="{{ url('assets/user/img/icons/spec-05.svg')}}" alt="img">6 Persons</span>
						</div>
						<a href="listing-details.html" class="btn btn-primary">Rent Now</a>
					</div>
					<!-- /Car Item -->
				...
				<div class="row row-gap-4 justify-content-center">
					...
					<div class="col-lg-4 col-md-6 d-flex">
						<div class="testimonial-item testimonial-item-two flex-fill">
							<div class="user-img">
								<img src="{{ url('assets/user/img/profiles/avatar-02.jpg')}}" class="img-fluid" alt="img">
							</div>
					...
					<div class="col-lg-4 col-md-6 d-flex">
						<div class="testimonial-item testimonial-item-two flex-fill">
							<div class="user-img">
								<img src="{{ url('assets/user/img/profiles/avatar-18.jpg')}}" class="img-fluid" alt="img">
							</div>
					...
					<div class="col-lg-4 col-md-6 d-flex">
						<div class="testimonial-item testimonial-item-two flex-fill">
							<div class="user-img">
								<img src="{{ url('assets/user/img/profiles/avatar-15.jpg')}}" class="img-fluid" alt="img">
							</div>
				...
				<div class="row row-gap-3 justify-content-center">
					...
					<div class="col-lg-4 col-md-6 d-flex">
						<div class="blog-item flex-fill">
							<div class="blog-img">
								<img src="{{ url('assets/user/img/blog/blog-11.jpg')}}" class="img-fluid" alt="img">
							</div>
					...
					<div class="col-lg-4 col-md-6 d-flex">
						<div class="blog-item flex-fill">
							<div class="blog-img">
								<img src="{{ url('assets/user/img/blog/blog-12.jpg')}}" class="img-fluid" alt="img">
							</div>
							<div class="blog-content">
								<div class="d-flex align-center justify-content-between blog-category">
									<a href="javascript:void(0);" class="category">Journey</a>
					...
					<div class="col-lg-4 col-md-6 d-flex">
						<div class="blog-item flex-fill">
							<div class="blog-img">
								<img src="{{ url('assets/user/img/blog/blog-13.jpg')}}" class="img-fluid" alt="img">
							</div>
							<div class="blog-content">
								<div class="d-flex align-center justify-content-between blog-category">
									<a href="javascript:void(0);" class="category">Journey</a>
					...
					<div class="row align-items-end">
						...
						<div class="col-md-6">
							<div class="subscribe-img">
								<img src="{{ url('assets/user/img/about/web-app.png')}}" alt="img" class="img-fluid">
							</div>
						</div>
					</div>
						...
						<div class="col-lg-5">
							<div class="footer-contact footer-widget">
								<div class="footer-logo">
									<img src="{{ url('assets/user/img/logo-white.svg')}}" class="img-fluid aos" alt="logo">
								</div>
	...
	<!-- jQuery -->
	<script src="{{ url('assets/js/jquery-3.7.1.min.js')}}" type="705cb7e2d14f5288c24a7639-text/javascript"></script>

	<!-- Bootstrap Core JS -->
	<script src="{{ url('assets/js/bootstrap.bundle.min.js')}}" type="705cb7e2d14f5288c24a7639-text/javascript"></script>

	<!-- counterup JS -->
	<script src="{{ url('assets/js/jquery.waypoints.js')}}" type="705cb7e2d14f5288c24a7639-text/javascript"></script>
	<script src="{{ url('assets/js/jquery.counterup.min.js')}}" type="705cb7e2d14f5288c24a7639-text/javascript"></script>
	
	<!-- Select2 JS -->
	<script src="{{ url('assets/plugins/select2/js/select2.min.js')}}" type="705cb7e2d14f5288c24a7639-text/javascript"></script>
	
	<!-- Aos -->
	<script src="{{ url('assets/plugins/aos/aos.js')}}" type="705cb7e2d14f5288c24a7639-text/javascript"></script>
	
	<!-- Top JS -->
	<script src="{{ url('assets/js/backToTop.js')}}" type="705cb7e2d14f5288c24a7639-text/javascript"></script>
	
	<!-- Owl Carousel JS -->
	<script src="{{ url('assets/js/owl.carousel.min.js')}}" type="705cb7e2d14f5288c24a7639-text/javascript"></script>

    <!-- Slick JS -->
    <script src="{{ url('assets/plugins/slick/slick.js')}}" type="705cb7e2d14f5288c24a7639-text/javascript"></script>	

    <!-- Flatpickr JS -->
    <script src="{{ url('assets/plugins/flatpickr/flatpickr.min.js')}}" type="705cb7e2d14f5288c24a7639-text/javascript"></script>	
    <script src="{{ url('assets/plugins/flatpickr/forms-pickers.js')}}" type="705cb7e2d14f5288c24a7639-text/javascript"></script>	
	
	<!-- Datepicker Core JS -->
	<script src="{{ url('assets/plugins/moment/moment.min.js')}}" type="705cb7e2d14f5288c24a7639-text/javascript"></script>
	<script src="{{ url('assets/js/bootstrap-datetimepicker.min.js')}}" type="705cb7e2d14f5288c24a7639-text/javascript"></script>

	<!-- Fancybox JS -->
	<script src="{{ url('assets/plugins/fancybox/fancybox.umd.js')}}" type="705cb7e2d14f5288c24a7639-text/javascript"></script>

	<!-- Custom JS -->
	<script src="{{ url('assets/js/script.js')}}" type="705cb7e2d14f5288c24a7639-text/javascript"></script>
	
<script src="{{ url('../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js')}}" data-cf-settings="705cb7e2d14f5288c24a7639-|49" defer></script><script defer src="../../../static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"97fffa7f8ad877d9","version":"2025.8.0","serverTiming":{"name":{"cfExtPri":true,"cfEdge":true,"cfOrigin":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"3ca157e612a14eccbb30cf6db6691c29","b":1}' crossorigin="anonymous"></script>
</body>

<!-- Mirrored from dreamsrent.dreamstechnologies.com/html/template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Sep 2025 11:21:56 GMT -->
</html>