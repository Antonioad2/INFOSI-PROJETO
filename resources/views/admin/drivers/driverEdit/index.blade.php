                        ...
                        <form action="{{ route('drivers.update', $driver) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="daily_price" id="daily_price" class="form-control @error('daily_price') is-invalid @enderror" value="{{ old('daily_price', $driver->daily_price) }}" min="0" step="0.01" required>
                                    @error('daily_price')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
