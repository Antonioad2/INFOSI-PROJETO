                    ...
                    <div class="card-body p-0">
                       ...
                       <div class="px-4 clearfix">
                        ...
                        <hr class="border-dashed"> -->
                                ...
                                <form action="{{ route('models.update', ['models' => $model->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 mb-4">
                                        ...
                                        <input type="text" name="name" class="form-control"
                                            value="{{ old('name', $model->name) }}" placeholder="Ex: Cinza, Azul...">
                                    </div>
                                    ...
                                    <div class="col-12 mb-4">
                                        ...
                                        <textarea name="description" class="form-control" rows="4" placeholder="Escreve uma descrição...">{{ old('description', $model->description ?? '' ) }}</textarea>
                                    </div>

                                    {{-- Botão de Enviar --}}
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary"> Atualizar Modelo
                                        </button>
                                    </div>
                                </div>
                            </form>
