    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item">Editar Modelo</li>
            </ul>
        </div>
                            ...
                            <div class="d-md-flex align-items-center justify-content-between">
                                <div class="mb-4 mb-md-0 your-brand">
                                    <div class="wd-100 ht-100 position-relative overflow-hidden border border-gray-2 rounded">
                                        <img src="{{ $model->image ? asset('storage/' . $model->image) : url('assets/images/logo-abbr.png') }}" class="upload-pic img-fluid rounded h-100 w-100" alt="Model Image">
                        ...
                        <form action="{{ route('models.update', ['model' => $model->id]) }}" method="POST" id="model-edit-form" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 mb-4">
                                    ...
                                    <input type="text" name="name" class="form-control" value="{{ old('name', $model->name) }}" placeholder="Ex: Starlet, Corolla..." required>
                                    @error('name')
                                ...
                                <div class="col-12 mb-4">
                                    ...
                                    <textarea name="description" class="form-control" rows="4" placeholder="Escreva uma descrição...">{{ old('description', $model->description) }}</textarea>
                                    @error('description')
                                        <span class="text-danger fs-12">{{ $message }}</span>
                                    @enderror
                                </div>
