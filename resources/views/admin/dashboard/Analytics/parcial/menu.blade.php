...
<<<<<<< HEAD:resources/views/proposal/proposalCreate/parcial/menu.blade.php
                    ...
                    <ul class="nxl-submenu">
                        ...
                        <li class="nxl-item"><a class="nxl-link" href="{{ route('colors.show', ['color' => $color->id]) }}">Criar Cor</a></li>
...
>>>>>>> Braulio:resources/views/admin/dashboard/Analytics/parcial/menu.blade.php
                    </a>
                    <ul class="nxl-submenu">
