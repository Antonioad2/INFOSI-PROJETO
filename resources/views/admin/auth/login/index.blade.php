...
<!-- Mirrored from bestwpware.com/html/tf/duralux-demo/auth-login-minimal.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 21 Jul 2025 12:20:57 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <div class="card-body p-sm-5">
                        ...
                        <form action="/admin" class="w-100 mt-4 pt-2">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div>
                                    <a href="{{route('admin.reset')}}" class="fs-11 text-primary">Forget password?</a>
                                </div>
                            </div>
                            <div class="mt-5">
