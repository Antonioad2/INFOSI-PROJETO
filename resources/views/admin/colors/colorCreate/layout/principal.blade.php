...
<body>
    @include('admin.colors.colorCreate.parcial.header')
    @include('admin.colors.colorCreate.parcial.menu')
    <main class="nxl-container">
        @yield('content-colorCreate')
        @include('admin.colors.colorCreate.parcial.footer')
    </main>
    @include('admin.colors.colorCreate.parcial.thema')
