@extends('color.colorCreate.layout.principal')
@section('title', 'Duralux || color Create')
@section('content-colorCreate')
            ...
            <div class="col-xl-4">
                ...
                <div class="card stretch stretch-full">
                    <div class="card-body">
                        <div class="mb-4 d-flex align-items-center justify-content-between">
                            <div>
                                <h6 class="fw-bold">color Methord:</h6>
                                <span class="fs-12 text-muted">Select color methord</span>
                            </div>
                            <div class="avatar-text avatar-sm" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Select color methord">
                                <i class="feather feather-info"></i>
                            </div>
                        </div>
                        <!-- Nav tabs -->
                ...
                <div class="card stretch stretch-full">
                    <div class="card-body">
                        ...
                        <div class="ps-0 form-check form-switch form-switch-sm d-flex align-center justify-content-between">
                            <label class="fw-bold text-dark" for="Savecolor">
                                <span>Save color</span>
                                <span class="fs-11 fw-normal text-muted d-block">Save color for quick payout</span>
                            </label>
                            <input class="form-check-input" type="checkbox" id="Savecolor">
                        </div>
                    </div>
                </div>
                <div class="card stretch stretch-full">
                    <div class="card-body">
                        ...
                        <p class="fs-12 text-muted mb-4">Are you sure you want to cancel this invoice? Neigther you nor alex will able to make any(more) colors on it.</p>
