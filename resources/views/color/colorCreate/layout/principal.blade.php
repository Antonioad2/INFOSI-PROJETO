...
<body>
    @include('color.colorCreate.parcial.header')
    @include('color.colorCreate.parcial.menu')
    <main class="nxl-container">
        @yield('content-colorCreate')
        @include('color.colorCreate.parcial.footer')
    </main>
    @include('color.colorCreate.parcial.thema')
